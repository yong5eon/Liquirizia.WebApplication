...
from .Implements.Form import Encoder as FormEncoder, Decoder as FormDecoder
...
class SerializerHelper(Singleton):
	...
	def __init__(self):
		self.serializers = {
			...
			'application/x-www-form-urlencoded': (FormEncoder, FormDecoder),
			'application/x-www-form': (FormEncoder, FormDecoder),
			'form-urlencoded': (FormEncoder, FormDecoder),
			'form': (FormEncoder, FormDecoder),
